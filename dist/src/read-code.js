...
function hashCode(code) {
    return js_sha3_1.sha3_256(code);
}
...
function readCodeFile(fileName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSourceCode(fileName)];
                case 1:
                    code = _a.sent();
                    ret = {
                        filename: fileName,
...
function readCodeFiles(options) {
    return __awaiter(this, void 0, void 0, function () {
        var filePaths, ret;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, globPromise(options.sourceFolder, {})];
                case 1:
                    filePaths = _a.sent();
                    return [4 /*yield*/, Promise.all(filePaths.map(function (file) { return readCodeFile(file); }))];
                case 2:
                    ret = _a.sent();
                    return [2 /*return*/, ret];
            }
...
exports.default = readCodeFiles;
//# sourceMappingURL=read-code.js.map