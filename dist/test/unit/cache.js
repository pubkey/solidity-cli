...
var basicCompiledPromise = null;
function basicCompiled() {
            ...
            switch (_a.label) {
                case 0:
                    if (!basicCompiledPromise) {
                        basicCompiledPromise = new Promise(function (res) { return __awaiter(_this, void 0, void 0, function () {
                            var files, compiled;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, read_code_1.default({
                    ...
                    return [4 /*yield*/, basicCompiledPromise];
                case 1:
                    value = _a.sent();
                    return [2 /*return*/, clone(value)];
            }
        });
    });
}
exports.basicCompiled = basicCompiled;
